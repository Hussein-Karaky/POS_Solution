    ...
    value: function colorPalette(className, tooltip, backColor, foreColor) {
      ...
      return this.ui.buttonGroup({
        ...
        children: [this.button({
          ...
          items: (backColor ? ['<div class="note-palette">', '<div class="note-palette-title">' + this.lang.color.background + '</div>', '<div>', '<button type="button" class="note-color-reset summer-btn summer-btn-light summer-btn-outline-dark" data-event="backColor" data-value="transparent">', this.lang.color.transparent, '</button>', '</div>', '<div class="note-holder" data-event="backColor"><!-- back colors --></div>', '<div>', '<button type="button" class="note-color-select summer-btn summer-btn-light summer-btn-outline-dark" data-event="openPalette" data-value="backColorPicker">', this.lang.color.cpSelect, '</button>', '<input type="color" id="backColorPicker" class="note-btn note-color-select-btn" value="' + this.options.colorButton.backColor + '" data-event="backColorPalette">', '</div>', '<div class="note-holder-custom" id="backColorPalette" data-event="backColor"></div>', '</div>'].join('') : '') + (foreColor ? ['<div class="note-palette">', '<div class="note-palette-title">' + this.lang.color.foreground + '</div>', '<div>', '<button type="button" class="note-color-reset summer-btn summer-btn-light summer-btn-outline-dark" data-event="removeFormat" data-value="foreColor">', this.lang.color.resetToDefault, '</button>', '</div>', '<div class="note-holder" data-event="foreColor"><!-- fore colors --></div>', '<div>', '<button type="button" class="note-color-select summer-btn summer-btn-light summer-btn-outline-dark" data-event="openPalette" data-value="foreColorPicker">', this.lang.color.cpSelect, '</button>', '<input type="color" id="foreColorPicker" class="note-btn note-color-select-btn" value="' + this.options.colorButton.foreColor + '" data-event="foreColorPalette">', '</div>', // Fix missing Div, Commented to find easily if it's wrong
...
var LinkDialog_LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'summer-btn summer-btn-primary note-btn note-btn-primary note-link-btn';
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'summer-btn summer-btn-primary note-btn note-btn-primary note-image-btn';
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'summer-btn summer-btn-primary note-btn note-btn-primary note-video-btn';
...
var buttonGroup = renderer["a" /* default */].create('<div class="note-btn-group summer-btn-group">');
...
var ui_ui = function ui(editorOptions) {
  return {
    ...
    button: function button($node, options) {
      return renderer["a" /* default */].create('<button type="button" class="note-btn summer-btn summer-btn-outline-dark summer-btn-sm" tabindex="-1">', function ($node, options) {
