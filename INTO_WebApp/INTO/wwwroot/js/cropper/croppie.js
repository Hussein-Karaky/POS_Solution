...
(function (root, factory) {
    ...
    function _create() {
        ...
        self.elements.preview.id = "canvas";
    ...
    function _initializeZoom() {
        ...
        addClass(wrap, 'btn-rounded');
        addClass(zoomer, 'cr-slider');
        addClass(zoomer, 'btn-rounded');
        zoomer.type = 'range';
        zoomer.step = '0.0001';
        zoomer.value = '1';
        ...
        let footer = document.querySelectorAll("#pictureCropper .modal-footer")[0];
    ...
    deepExtend(Croppie.prototype, {
        ...
        initZoom: function () {
            return _initializeResize.call(this);
        },
        updateOverlay: function () {
            return _updateOverlay.call(self);
        },
        updateZoomLimits: function () {
            return _updateZoomLimits.call();
        },
        updateCenterPoint: function () {
            return _updateCenterPoint.call(self);
        },
        triggerUpdate: function () {
            return _triggerUpdate.call(self);
        }
    });
    return Croppie;
}));
