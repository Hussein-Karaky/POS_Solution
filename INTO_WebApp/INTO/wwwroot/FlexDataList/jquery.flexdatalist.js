...
jQuery.fn.flexdatalist = function (_option, _value) {
    ...
    return this.each(function (id) {
        ...
        this.init = function () {
            ...
            $alias
                ...
                .on('input keyup', function (event) {
                    ...
                    if (event.keyCode === 188 && inptval.length < 4) {
                        inpt.val(inptval.replaceAll(',', ''));
                    }
        ...
        this.action = {
             ...
             */
            //zeinab: val.length => length of inputed text at keyevent 13=enter and 188=','
            keypressValue: function (event, keyCode) {
                ...
                if (val.replaceAll(',','').length > 2
                    ...
                    _this.fvalue.extract(val.replaceAll(',',''));
                    _this.results.remove();
                }
            },
            /**
